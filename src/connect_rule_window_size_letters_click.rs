...
pub fn connect_rule_window_size_letters_click(gui_data: &GuiData) {
    ...
    check_button_letters_type_lowercase.connect_clicked(move |_e| {
        update_examples(&window_rules, None);
    });
    let window_rules = gui_data.window_rules.clone();
    check_button_letters_type_uppercase.connect_clicked(move |_e| {
        update_examples(&window_rules, None);
    });
    let window_rules = gui_data.window_rules.clone();
    check_button_letters_usage_extension.connect_clicked(move |_e| {
        update_examples(&window_rules, None);
    });
    let window_rules = gui_data.window_rules.clone();
    check_button_letters_usage_name.connect_clicked(move |_e| {
        update_examples(&window_rules, None);
    });
    let window_rules = gui_data.window_rules.clone();
    check_button_letters_usage_both.connect_clicked(move |_e| {
        update_examples(&window_rules, None);
    });
}
