...
pub fn connect_rule_window_trim_click(gui_data: &GuiData) {
    ...
    //
    // check_button_trim_name_start.connect_clicked(move |_e| {
    //     update_examples(&window_rules, None);
    // });
    // let window_rules = gui_data.window_rules.clone();
    // check_button_trim_name_end.connect_clicked(move |_e| {
    //     update_examples(&window_rules, None);
    // });
    // let window_rules = gui_data.window_rules.clone();
    // check_button_trim_extension_start.connect_clicked(move |_e| {
    //     update_examples(&window_rules, None);
    // });
    // let window_rules = gui_data.window_rules.clone();
    // check_button_trim_extension_end.connect_clicked(move |_e| {
    //     update_examples(&window_rules, None);
    // });
    // let window_rules = gui_data.window_rules.clone();
    // check_button_trim_case_insensitive.connect_clicked(move |_e| {
    //     update_examples(&window_rules, None);
    // });
    // let window_rules = gui_data.window_rules.clone();
    // check_button_trim_case_sensitive.connect_clicked(move |_e| {
    //     update_examples(&window_rules, None);
    // });
    // let window_rules = gui_data.window_rules.clone();
