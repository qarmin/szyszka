...
pub fn rule_remove(data_to_change: &str, rule_type: &RuleType, rule_place: &RulePlace) -> String {
    ...
    match rule_type {
        RuleType::Remove => match rule_place {
            RulePlace::Name => {
        ...
        _ => panic!("Invalid Rule Type for remove rule"),
    }
